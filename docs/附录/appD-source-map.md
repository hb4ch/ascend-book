...
| 章 | 主来源路径 |
|---|---|
| 第9章 编程模型与 API 选择 | `asc-devkit/README.md`，`asc-devkit/docs/zh/asc_how_to_choose_api.md`，`asc-devkit/docs/zh/guide/programming_guide/programming_model/` |
| 第10章 核心编程能力 | `asc-devkit/impl/{basic_api,c_api,tensor_api,aicpu_api}/`，`asc-devkit/include/`，`asc-devkit/examples/{01_simd_cpp_api,02_simd_c_api}/`，`docs/zh/guide/programming_guide/ai_core_simd_programming/` |
| 第11章 SIMD/SIMT 与高级特性 | `asc-devkit/impl/{simt_api,c_api}/`，`asc-devkit/docs/zh/asc_950_feature_guide.md`，`asc-devkit/examples/{03_simt_api,05_simd_simt_hybrid}/`，`cann-learning-hub/blogs/operator/regbase_vec_add/` |
